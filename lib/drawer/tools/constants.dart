...
class DrawerTextConstants {
  ...
  static const String androidAppLink =
      "https://play.google.com/store/apps/details?id=fr.myemapp.titan";
  static const String copied = "Copié !";
  static const String downloadAppOnMobileDevice =
      "Ce site est la version Web de l'application MyEMApp. Nous vous invitons à télécharger l'application. N'utilisez ce site qu'en cas de problème avec l'application.\n";
  static const String iosAppLink =
      "https://apps.apple.com/fr/app/myemapp/id6444443430";
