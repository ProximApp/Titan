...
class EmptyModels {
  ...
  static T empty<T>() {
    ...
    if (!_factories.containsKey(T)) {
      ...
      throw FlutterError(
        'No empty factory registered for type $T. '
...
void registerAllEmptyFactories() {
  ...
  EmptyModels.register<CoreGroup>(() => CoreGroup(id: '', name: ''));

  EmptyModels.register<CoreGroupSimple>(
    () => CoreGroupSimple(id: '', name: ''),
  );
  ...
  EmptyModels.register<RoomComplete>(
    () => RoomComplete(id: '', name: '', managerId: ''),
  );
  ...
  EmptyModels.register<Manager>(() => Manager(groupId: '', name: '', id: ''));
  ...
  EmptyModels.register<SellerComplete>(
    () => SellerComplete(id: '', name: '', groupId: '', order: 0),
  );

  EmptyModels.register<PackTicketSimple>(
    () => PackTicketSimple(id: '', price: 0.0, packSize: 0, raffleId: ''),
  );
  ...
  EmptyModels.register<RaffleComplete>(
    () => RaffleComplete(id: '', name: '', description: '', groupId: ''),
  );

  EmptyModels.register<RaffleStats>(
    () => RaffleStats(ticketsSold: 0, amountRaised: 0.0),
  );
  ...
  EmptyModels.register<SectionComplete>(
    () => SectionComplete(id: '', name: '', description: ''),
  );
  ...
  EmptyModels.register<AppModulesCampaignSchemasCampaignResult>(
    () => AppModulesCampaignSchemasCampaignResult(listId: '', count: 0),
  );
}
