        ...
        children: [
          ...
          Expanded(
            child: Refresher(
              ...
              child:
                  AsyncChild<List<AppCoreTicketsSchemasTicketsTicketComplete>>(
                    ...
                    builder: (context, tickets) {
                      ...
                      final sortedTickets = [...tickets]
                        ..sort((a, b) {
                          final aUpcoming = a.session.startDatetime.isAfter(
                            now,
                          );
                          final bUpcoming = b.session.startDatetime.isAfter(
                            now,
                          );
