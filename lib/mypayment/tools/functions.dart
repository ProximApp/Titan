...
/// Returns true when a payment request has passed its expiration date,
/// even if the backend still reports it as `proposed`.
bool isRequestExpired(Request$ request) {
  return !request.expirationDate.isAfter(DateTime.now());
}
